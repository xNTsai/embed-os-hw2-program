...
#define MBED_CONF_APP_HOSTNAME                                                  "172.20.10.14"                                                                                   // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "2003920315"                                                                                     // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "xN"                                                                                             // set by application[*]
